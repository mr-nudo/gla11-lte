                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="/employees/{{ $user->id }}" method="POST" id="employeeDelete--{{ $user->id }}">
                                                                {{ method_field('delete') }}
                                                                {!! csrf_field() !!}
                                                            </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/employees" method="post" id="adminForm">
                    {!! csrf_field() !!}
                        ...
                        <select class="custom-select custom-select-sm form-control form-control-sm" name="company_id" required>
