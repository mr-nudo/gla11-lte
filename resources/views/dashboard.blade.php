        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Card 1 -->
                    @if($session_user->role_id == 3 || $session_user->role_id == 4)
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <a href = "/companies/{{$session_user->company_id}}">View Company Details</a></div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <a href = "/companies/{{$session_user->company_id}}/employees">View Employees</a></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">-</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                            <a href = "/admins">Manage Admins</a></div>
                                        <div class="h5 mb-0 font-weight-bold text-red-800">-</div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-cog fa-2x text-red-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                            <a href = "/companies">Manage Companies</a></div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">-</div>
                                    </div>
                                    <div class="col-auto">
